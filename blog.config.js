...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '求知者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,求知', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由求知者运营的站点', // 站点描述，被notion中的页面描述覆盖
